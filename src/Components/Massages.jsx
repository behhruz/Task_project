...
const Massages = () => {
  ...
  return (
    <div className="p-4 w-full h-full max-w-full mx-auto">
      <h1 className="text-2xl font-bold text-blue-600 mb-4">Messages</h1>
      <div className="space-y-4 overflow-y-auto max-h-[80vh]">
        {messages.map((message) => (
          ...
          >
            <div
              className={`bg-${message.sender === "Me" ? "[#8774E1]" : "white"} 
              text-${message.sender === "Me" ? "white" : "black"} rounded-2xl 
